...
export class BaseCommand implements ICommandComponent {
    public constructor(public client: ZhycorpCore, public meta: ICommandComponent["meta"]) {}
    ...
    public reload(): ICommandComponent {
        ...
        this.client.logger.info(`${this.meta.name} command from ${this.meta.category!} category has been reloaded`);
